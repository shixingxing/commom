...
public class SymbolInfo {
    ...
    static final SymbolInfo[] PROD_SYMBOLS = { new SymbolInfo(false, 3, 5, 8, 8, 1),
            ...
            new SymbolInfo(false, 36, 24, 22, 22, 1), new SymbolInfo(false, 44, 28, 24, 24, 1),
    ...
    SymbolInfo(boolean rectangular, int dataCapacity, int errorCodewords, int matrixWidth,
            int matrixHeight, int dataRegions, int rsBlockData, int rsBlockError) {
    ...
    public static SymbolInfo lookup(int dataCodewords, SymbolShapeHint shape, Dimension minSize,
        ...
        for (SymbolInfo symbol : symbols) {
            ...
            if (minSize != null
                    && (symbol.getSymbolWidth() < minSize.getWidth() || symbol.getSymbolHeight() < minSize
                            .getHeight())) {
                continue;
            }
            if (maxSize != null
                    && (symbol.getSymbolWidth() > maxSize.getWidth() || symbol.getSymbolHeight() > maxSize
                            .getHeight())) {
                continue;
            }
